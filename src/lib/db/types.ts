...
export interface DatabaseAdapter {
  ...
  user: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any>; select?: Record<string, boolean>; cursor?: Record<string, any> }): Promise<any[]>;
    ...
    groupBy(params: { by: string[]; where?: Record<string, any>; _count?: Record<string, boolean>; _sum?: Record<string, boolean>; orderBy?: Record<string, any> }): Promise<any[]>;
  };
  ...
  like: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any> }): Promise<DbLike[]>;
    delete(where: { id: string }): Promise<void>;
    deleteMany(where: Record<string, any>): Promise<number>;
    count(where?: Record<string, any>): Promise<number>;
    groupBy(params: { by: string[]; where?: Record<string, any>; _count?: Record<string, boolean> }): Promise<any[]>;
  };

  match: {
    create(data: Partial<DbMatch>): Promise<DbMatch>;
    findUnique(where: { user1Id?: string; user2Id?: string; id?: string }): Promise<DbMatch | null>;
    findFirst(where?: Record<string, any>): Promise<DbMatch | null>;
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any>; includeLastMessage?: boolean }): Promise<any[]>;
    delete(where: { id: string }): Promise<void>;
    deleteMany(where: Record<string, any>): Promise<number>;
    count(where?: Record<string, any>): Promise<number>;
    groupBy(params: { by: string[]; where?: Record<string, any>; _count?: Record<string, boolean> }): Promise<any[]>;
  ...
  message: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any> }): Promise<DbMessage[]>;
    findFirst(where?: Record<string, any>, options?: { orderBy?: Record<string, any> }): Promise<DbMessage | null>;
    updateMany(where: Record<string, any>, data: Partial<DbMessage>): Promise<number>;
    deleteMany(where: Record<string, any>): Promise<number>;
    count(where?: Record<string, any>): Promise<number>;
    groupBy(params: { by: string[]; where?: Record<string, any>; _count?: Record<string, boolean> }): Promise<any[]>;
  };
  ...
  block: {
    ...
    findMany(where?: Record<string, any>): Promise<DbBlock[]>;
    deleteMany(where: Record<string, any>): Promise<number>;
    count(where?: Record<string, any>): Promise<number>;
  };
  ...
  moment: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any> }): Promise<DbMoment[]>;
  ...
  momentComment: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any> }): Promise<DbMomentComment[]>;
    deleteMany(where: Record<string, any>): Promise<number>;
    count(where?: Record<string, any>): Promise<number>;
  };
  ...
  momentReaction: {
    ...
    findMany(where?: Record<string, any>, options?: { skip?: number; take?: number; orderBy?: Record<string, any> }): Promise<DbMomentReaction[]>;
  ...
  userAchievement: {
    ...
    findMany(where?: Record<string, any>): Promise<DbUserAchievement[]>;
